...
const e = s.event((e) => console.log(e))
...
const caseHyperScript = s('button', { onclick: () => {} }, [
  s('a', { href: '' }, 'click')
])
...
s(({ autoplay = false, images = [] }, [], context) => {
...
s(({
  ...
  `({
    ...
    `({
      onclick: (e, dom) => {
        dom.previousSibling.value = initial = value = '', save(dom)
